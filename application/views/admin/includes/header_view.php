...
<head>
  ...
  <!-- Stylesheets -->
  <link href="<?php echo base_url(); ?>assets/style/bootstrap-2.2.2.min.css" rel="stylesheet">
  <!-- Font awesome icon -->
  ...
  <link href="<?php echo base_url(); ?>assets/style/pick-a-color-1.1.7.min.css" rel="stylesheet">
...
<div class="navbar navbar-fixed-top navbar-inverse">
  <div class="navbar-inner">
    <div class="container">
      ...
      <a href="<?php echo site_url("admin"); ?>" class="brand"><img src="<?php echo base_url(); ?>assets/img/logo24x24.png" style="vertical-align:middle;"> Dermatológica <span class="bold"></span></a>
        ...
        <ul class="nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <?php echo ($this->session->userdata('user_level') == $this->config->item('admin_level')) ? "Administrador | ".ucwords($this->session->userdata('sucursal')->nombre): "Usuario |" .ucwords($this->session->userdata('sucursal')->nombre); ?> <b class="caret"></b>              
            </a>
