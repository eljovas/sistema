...
<div class="navbar navbar-fixed-top navbar-inverse">
  <div class="navbar-inner">
    <div class="container">
      ...
      <a href="<?php echo site_url("admin"); ?>" class="brand">FRIGOMAR <span class="bold"></span></a>
        ...
        <ul class="nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <?php echo ($this->session->userdata('user_level') == $this->config->item('admin_level')) ? "Administrador" : ($this->session->userdata('user_level')==1)?"Mesa de Control":"Cliente"; ?> <b class="caret"></b>              
            </a>
