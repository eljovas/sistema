...
<div class="sidebar">
   ...
   <div class="widget wlightblue">
                ...
                <div class="widget-head">
                  <div class="pull-left">Editar Información de Paciente</div>
                  <div class="clearfix"></div>
                </div>
						...
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									...
									<input type="hidden" id="sexo" name="sexo" value="<?php echo $cliente->genero; ?>">
								</div>
							</div>                          
						</div>
                      ...
                      <div class="row">
                        ...
                        <div class="span4">
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" id="nombre" name="nombre" class="span3" value="<?php echo $cliente->nombre; ?>">
                              </div>
                            </div>
                        </div>
                        <div class="span4">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input type="text" id="apellidos" name="apellidos" class="span3" value="<?php echo $cliente->apellido; ?>">
                            </div>
                          </div>                          
                        </div>
                      </div>                      
					...
					<div class="row">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="estado_civil" name="estado_civil">
										...
										<option <?php echo ($cliente->edo_civil=="soltero")?"selected":""; ?> value="soltero">Soltero(a)</option>
										<option <?php echo ($cliente->edo_civil=="union libre")?"selected":""; ?> value="union libre">Union libre</option>
										<option <?php echo ($cliente->edo_civil=="casado")?"selected":""; ?> value="casado">Casado(a)</option>
										<option <?php echo ($cliente->edo_civil=="divorciado")?"selected":""; ?> value="divorciado">Divorciado(a)</option>
										<option <?php echo ($cliente->edo_civil=="viudo")?"selected":""; ?> value="viudo">Viudo(a)</option>
										<option <?php echo ($cliente->edo_civil=="sin especificar")?"selected":""; ?> value="sin especificar">Sin especificar</option>
									</select>
								</div>
							</div>                          
						</div>
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="profesion" name="profesion"  class="span3" value="<?php echo $cliente->profesion; ?>">
								</div>
							</div>                          
						</div>
					</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="motivo" name="motivo">
										<option value="1">Seleccioa Procedimiento</option>
										
										<?php 
										if (isset($procedimientos) && !empty($procedimientos)) {
											foreach ($procedimientos as $procedimiento) {
												if ($cliente->motivo==$procedimiento->id) {
									...
									<select id="doctor" name="doctor">
										...
										if (isset($doctores) && !empty($doctores)) {
											foreach ($doctores as $doctor) {
												if ($cliente->doctor==$doctor->user_id) {
							...
							<div  class="control-group">
								...
								<div class="controls">
									<div id="datetimepicker1" class="input-append readonly">
										<input data-format="yyyy-MM-dd" type="text" id="fecha_nacimiento" name="fecha_nacimiento" class="span2" readonly value="<?php echo $cliente->fecha_nacimiento; ?>">
										<span class="add-on">
							...
							<div class="control-group">
								...
								<div class="controls">
									<div id="datetimepicker3" class="input-append readonly">
										<input data-format="yyyy-MM-dd" type="text" id="fecha_ingreso" name="fecha_ingreso" class="span2" readonly value="<?php echo $cliente->fecha_ingreso; ?>">
										<span class="add-on">
											<i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
										</span>
									</div>
					...
					<div class="row">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="tipo_consulta" name="tipo_consulta">
										...
										<option <?php echo ($cliente->tipo_consulta=="particular")?"selected":""; ?> value="particular">Particular</option>
										<option <?php echo ($cliente->tipo_consulta=="empresa")?"selected":""; ?> value="empresa">Empresa</option>
									</select>
								</div>
							</div>                          
						</div>
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input disabled="disabled" type="text" id="empresa" name="empresa" class="span3" value="<?php echo $cliente->empresa; ?>">
								</div>
							</div>                          
						</div>
					</div>
					...
					<div class="row">
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="recomendado" name="recomendado" class="span3" value="<?php echo $cliente->recomendacion; ?>">
								</div>
							</div>                          
						</div>
					</div>
					...
					<div class="row">
						<div class="span8">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="domicilio" name="domicilio" class="span7" value="<?php echo $cliente->domicilio; ?>">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="tel" id="telefono" name="telefono" class="span3 bfh-phone" data-format="(ddd) ddd-dddd" data-number="<?php echo $cliente->telefono_contacto; ?>" value="<?php echo $cliente->telefono_contacto; ?>">
								</div>
							</div>
						</div>
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="email" id="correo" name="correo" class="span3" value="<?php echo $cliente->email_contacto; ?>">
								</div>
							</div>
						</div>
					</div>
								...
								<div class="controls">
									<select id="pais" name="pais" data-provide="typeahead">
										...
										foreach ($paises as $pais) {
											if ($cliente->pais==$pais->Code) {
												echo "<option selected value=\"".$pais->Code."\">".$pais->Name."</option>";	
											}else{
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="estado" name="estado" data-provide="typeahead">
										...
										<?php 
										$estados=simplexml_load_file("./estados.xml");
										foreach ($estados as $estado) {
											if ($cliente->estado==$estado->Name) {
												echo "<option selected value=\"".$estado->Code."\">".$estado->Name."</option>";
											}else{
											echo "<option value=\"".$estado->Code."\">".$estado->Name."</option>";
											}
										}
										?>										
									</select>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="ciudad" name="ciudad">
										...
										<?php 
										$ciudades=simplexml_load_file("./ciudades.xml");
										foreach ($ciudades as $ciudad) {
											if ($cliente->ciudad==$ciudad->Name) {
												echo "<option selected value=\"".$ciudad->Code."\">".$ciudad->Name."</option>";
											}else{
												echo "<option value=\"".$ciudad->Code."\">".$ciudad->Name."</option>";
											}
										}
										?>										
									</select>
					...
					<div class="row">
						<div class="span8">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="nombre_emergencia" name="nombre_emergencia" class="span7" value="<?php echo $cliente->emergencia_nombre; ?>">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="tel" id="telefono_emergencia" name="telefono_emergencia" class="span3 bfh-phone" data-format="(ddd) ddd-dddd" data-number="<?php echo $cliente->emergencia_telefono; ?>" value="<?php echo $cliente->emergencia_telefono; ?>">
								</div>
							</div>
						</div>
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="tel" id="celular_emergencia" name="celular_emergencia" class="span3 bfh-phone" data-format="(ddd) ddd-dddd" data-number="<?php echo $cliente->emergencia_celular; ?>" value="<?php echo $cliente->emergencia_celular; ?>">
								</div>
							</div>
						</div>
					</div>
