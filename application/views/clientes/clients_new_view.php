					...
					<div class="row">
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="tel" id="telefono_emergencia" name="telefono_emergencia" class="span3 bfh-phone" data-format="(ddd) ddd-dddd">
								</div>
							</div>
						</div>
						<div class="span4">
							<div class="control-group">
								...
								<div class="controls">
									<input type="tel" id="celular_emergencia" name="celular_emergencia" class="span3 bfh-phone" data-format="(ddd) ddd-dddd">
								</div>
							</div>
						</div>
					</div>
