<?php echo heading('Update Account', 1, 'class="page_header"'); ?>

<?php $update_form = array('class' => 'form'); ?>
<?php echo form_open('account/update', $update_form); ?>
...
<div class="form_button"><?php echo form_submit('submit', 'Update Account'); ?></div>
