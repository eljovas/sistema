...
<div class="content">
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
		...
		<div id="botones-cita-actual" class="modal-footer">
			...
			<button id="editarcita" class="btn btn-warning">editar</button>
			<button id="cancelandocita" class="btn btn-danger">cancelar</button>
		...
		<div id="botones-nuevo-paciente" class="modal-footer">
			<button class="btn" data-dismiss="modal" aria-hidden="true">cerrar</button>
			<button id="grabarpaciente" class="btn btn-success">grabar</button>
		</div>		
	</div>
	...
	<div class="sidebar">
		...
		<div class="sidebar-inner">
			...
			<?php $data["current"] = NULL; $this->load->view("recepcionistas/includes/menu",$data); ?>
          </ul>
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<a style="float: right; cursor: pointer;" id="quickadd" role="button"> <i class="icon-plus"></i> nuevo paciente</a>

          <div class="row-fluid">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a href="#cosmetologas" data-toggle="tab">Cosmetologas</a></li>
					<li><a href="#doctores" data-toggle="tab">Doctores</a></li>
				</ul>
				<div id="myTabContent" class="tab-content">
					<div class="tab-pane fade in active" id="cosmetologas">
						<div id="calendarCosmetologa"></div>
					</div>
					<div class="tab-pane fade" id="doctores">
