...
<head>
  ...
  <!--<link rel="stylesheet" href="<?php echo base_url(); ?>assets/style/fullcalendar.print.css">-->
  <!-- prettyPhoto -->
  ...
  <link href="<?php echo base_url(); ?>assets/style/bootstrap-combobox.css" rel="stylesheet">
  <link href="<?php echo base_url(); ?>assets/style/bootstrapSwitch.css" rel="stylesheet">
  <link href="<?php echo base_url(); ?>assets/style/bootstrap-modal.css" rel="stylesheet">
  <link href="<?php echo base_url(); ?>assets/style/bootstrap-editable.css" rel="stylesheet">
...
<div class="navbar navbar-fixed-top navbar-inverse">
  <div class="navbar-inner">
    <div class="container">
      ...
      <a href="<?php echo site_url("recepcionistas"); ?>" class="brand"><img src="<?php echo base_url(); ?>assets/img/logo24x24.png" style="vertical-align:middle;"> Dermatológica <span class="bold"></span></a>
        ...
        <ul class="nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <?php echo ($this->session->userdata('user_level') == $this->config->item('admin_level')) ? "Administrador" : ($this->session->userdata('user_level')==3)?"Recepcionista: ".$this->session->userdata('first_name')." | ".ucwords($this->session->userdata('sucursal')->nombre):"Cliente"; ?> <b class="caret"></b>              
            </a>
