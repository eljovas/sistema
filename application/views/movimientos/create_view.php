            ...
            <div class="span12">
              ...
              <div class="widget wlightblue">
                ...
                <div class="widget-head">
                  <div class="pull-left">Salida # <strong><?php $salida_folio = random_string('numeric', 3); echo "KM-".$salida_folio; ?></strong></div>
...
<?php if (!empty($message)) { echo $message; } ?>
          ...
          <?php $create_form = array('id'=>'users-form','class' => 'form-horizontal'); ?>
              ...
              <?php echo form_open('almacen/grabar_salida', $create_form); ?>
                      <input type="hidden" id="folio" name="folio" value="<?php echo $salida_folio; ?>">
                      <div class="row-fluid">
                     ...
                     <div class="row-fluid">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="nombre_recibe" name="fecha" value="<?php echo date("Y-m-d"); ?>"  class="span4" readonly>
                        </div>
                      </div>
                      </div>
                      <div class="span6">
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="destino" name="destino" value="<?php echo set_value('destino'); ?>"  class="span7">
                        </div>
                      </div>
                      </div>
                    </div>
                    <div class="row-fluid">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="recoge" name="recoge" value="<?php echo set_value('recoge'); ?>"  class="span12">
                        </div>
                      </div>
                      </div>
                      <div class="span6">
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="transporte" name="transporte" value="<?php echo set_value('transporte'); ?>"  class="span7">
                        </div>
                      </div>                        
                      </div>
                      </div>
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="placas" name="placas" value="<?php echo set_value('placas'); ?>">
                        </div>
                      </div>
                      </div>
                      <div class="span6">
                      <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="descripcion" name="descripcion" value="<?php echo set_value('descripcion'); ?>" class="span12">
                        </div>
                      </div>
                      </div>
                      </div>
