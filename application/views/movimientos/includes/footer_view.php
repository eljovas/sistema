...
$(function () {
$('#buscarajaxtarima').click(function() {
    $("#resumen-tarima").html("buscando...");
    var tarima = $("#espacio-origen").val();
    $.get('<?php echo site_url(); ?>/almacen/buscartarimajax/'+tarima, function(data) {
        $("#resumen-tarima").html(data);
    });
    $("#espacio-destino").attr("disabled",false);
    $("#codigo_producto_mov").attr("disabled",false);
    $("#kilos_mov").attr("disabled",false);
