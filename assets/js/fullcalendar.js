...
function ResourceEventRenderer() {
    ...
    function slotSegHtml(event, seg) {
    	var style = "color:#fff;background-color:#"+event.color+"!important;";
        var html = "<";
        var url = event.url;
        ...
        "<div class='fc-event-time' style='"+style+"'>" +
        htmlEscape(formatDates(event.start, event.end, opt('timeFormat'))) +
        "</div>" +
        "</div>" +
        "<div class='fc-event-content' style='"+style+"'>" +
        "<div class='fc-event-title' style='"+style+"'>" +
        htmlEscape(event.title) +
        "</div>" +
        "</div>" +
        "<div class='fc-event-bg' style='"+style+"'></div>" +
        "</div>"; // close inner
        if (seg.isEnd && isEventResizable(event)) {
            html +=
